<div class="min-h-screen grid grid-cols-1 lg:grid-cols-12 font-sans bg-base-100 text-base-content">
    ...
    <div class="lg:col-span-5 flex flex-col justify-center items-center p-8 lg:p-16 bg-white dark:bg-base-100">
        <div class="w-full max-w-sm space-y-8">
            ...
            <div class="space-y-2">
                <h2 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Buat Password Baru</h2>
                <p class="text-slate-500">Silakan masukkan password baru untuk akun <span
                        class="font-semibold text-slate-700">{{ $email }}</span></p>
            </div>
